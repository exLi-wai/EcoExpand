...
public class EStorageCellMana extends EStorageCell<IAEItemStack> {
    ...
    public EStorageCellMana(final DriveStorageLevel level, final int millionBytes, final int byteMultiplier) {
        ...
        setRegistryName(new ResourceLocation(Tags.MOD_ID, "estorage_cell_mana_" + millionBytes + "m"));
        setTranslationKey(Tags.MOD_ID + '.' + "estorage_cell_mana_" + millionBytes + "m");
    }
